...
const playerClubInst = CustomSelect.init(document.getElementById("playerClub"), {
  showImage: true,
  placeholder: "Choose nationality",
  imgSize: "w-auto h-7",
});

const positionInst = CustomSelect.init(document.getElementById("position"), {
  showImage: false,
  placeholder: "Select Player's Position",
});

const preferredFootInst = CustomSelect.init(
...
const joinedClubFootInst = CustomSelect.init(
